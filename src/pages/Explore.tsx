...
import { usePurchaseHistory, type ReceiptResponse } from "src/hooks/usePayment";
...
export default function Explore() {
    ...
    const purchasedSlideIds = useMemo(() => {
        ...
        return new Set((purchaseHistory as ReceiptResponse[]).flatMap(receipt => receipt.purchasedItems.map(item => item.slideId)));
    }, [purchaseHistory]);
